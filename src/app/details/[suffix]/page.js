      ...
      <div className="bg-red-800 py-3">
        ...
        {Object.keys(data).length > 0 ? (
          <div className="bg-white h-auto md:max-w-full rounded-lg shadow-lg p-5 m-5 md:mx-auto md:w-1/2">
            ...
            <h1 className="text-4xl">Short Bio</h1>
            <h2 className="text-xl shadow rounded p-3 mb-2 hover:text-white hover:bg-red-800 duration-300">
              Name: {data.name}
            </h2>
            <h2 className="text-xl shadow rounded p-3 mb-2 hover:text-white hover:bg-red-800 duration-300">
            ...
            <h1 className="text-4xl">Professional Careers</h1>
            <h2 className="text-xl shadow rounded p-3 mb-2 hover:text-white hover:bg-red-800 duration-300">
            ...
            <h2 onClick={() => {setShowDetail(!showDetail)}} className="cursor-pointer text-xl shadow rounded p-3 mb-2 hover:text-white hover:bg-red-800 duration-300">
